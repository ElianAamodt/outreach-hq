...
const DEFAULT_CANDIDATES = [
  ...
  // NYE Regnskap — Oslo-byrå (verifiser alle på proff.no)
  { id:mkId(), name:'Majorstuen Regnskap AS', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'telefon', planned:'', address:'Majorstuen', owner:'Elian', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Antatt lite byrå nær Majorstuen', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Tøyen Regnskapskontor', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'epost', planned:'', address:'Tøyen', owner:'Ulrik', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Østkant-byrå, sannsynlig småbedrift-fokus', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'St. Hanshaugen Regnskap', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'telefon', planned:'', address:'St. Hanshaugen', owner:'Elian', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Sentralt beliggende, typisk 2-5 ansatte', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Nydalen Økonomi AS', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'epost', planned:'', address:'Nydalen', owner:'Ulrik', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Nær BI, sannsynlig tech-vant klientbase', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Økonomihuset Oslo', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'telefon', planned:'', address:'Oslo sentrum', owner:'Elian', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Generalist regnskapsbyrå', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Regnskapseksperten AS', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'epost', planned:'', address:'Oslo', owner:'Ulrik', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Navngitt som ekspert — markedsfører seg mot SMB', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Sinsen Regnskap & Rådgivning', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'telefon', planned:'', address:'Sinsen', owner:'Elian', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Rådgivningsfokus — kan ha mer kompleks admin', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Bislett Regnskapsbyrå', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'epost', planned:'', address:'Bislett', owner:'Ulrik', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Antatt lite lokalt byrå', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Storo Økonomiservice', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'telefon', planned:'', address:'Storo', owner:'Elian', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Nær Storo Storsenter — betjener lokale bedrifter', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Løren Regnskap AS', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'epost', planned:'', address:'Løren', owner:'Ulrik', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Nytt boligområde — mange nyetableringer', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Torshov Regnskap', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'telefon', planned:'', address:'Torshov', owner:'Elian', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Lokalt byrå, nordøst-Oslo', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Kampen Regnskapskontor', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'epost', planned:'', address:'Kampen', owner:'Ulrik', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Lite byrå i tradisjonelt Oslo-strøk', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Carl Berner Økonomi', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'telefon', planned:'', address:'Carl Berner', owner:'Elian', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Sentralt knutepunkt, mange små virksomheter rundt', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Bryn Regnskapshjelp AS', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'epost', planned:'', address:'Bryn', owner:'Ulrik', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Nær Brynseng — kontor- og næringsstrøk', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Hasle Regnskap & Økonomi', dl:'Verifiser på proff.no', phone:'', email:'', category:'Regnskap', channel:'telefon', planned:'', address:'Hasle', owner:'Elian', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Voksende område med mange nye bedrifter', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  // NYE Jus — Oslo advokatfirma (verifiser alle på proff.no)
  { id:mkId(), name:'Advokatfirmaet Sentrum', dl:'Verifiser på proff.no', phone:'', email:'', category:'Jus', channel:'telefon', planned:'', address:'Oslo sentrum', owner:'Ulrik', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Lite sentrumsfirma, sannsynlig 2-4 advokater', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Advokat Grünerløkka', dl:'Verifiser på proff.no', phone:'', email:'', category:'Jus', channel:'epost', planned:'', address:'Grünerløkka', owner:'Elian', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Lokalt firma, privatklient-fokus', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Frogner Advokatkontor', dl:'Verifiser på proff.no', phone:'', email:'', category:'Jus', channel:'telefon', planned:'', address:'Frogner', owner:'Ulrik', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Vest-Oslo, antatt eiendom og familie-rett', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Advokatene på Majorstuen', dl:'Verifiser på proff.no', phone:'', email:'', category:'Jus', channel:'epost', planned:'', address:'Majorstuen', owner:'Elian', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Fellesskap av selvstendige advokater', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  { id:mkId(), name:'Nydalen Advokat AS', dl:'Verifiser på proff.no', phone:'', email:'', category:'Jus', channel:'telefon', planned:'', address:'Nydalen', owner:'Ulrik', status:'ikke-kontaktet', fitScore:0, painPoints:['','',''], nextStep:'', notes:'Næringsrettet, nær mange kontorbedrifter', gatekeeper:'', callAttempts:0, history:[], lastContacted:null, lastUpdatedBy:null, lastUpdatedAt:null, role:'pilot', needsVerify:true },
  // PILOT — Jus (eksisterende)
