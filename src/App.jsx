...
const DEFAULT_CANDIDATES = [
  ...
  { id:mkId(), name:'Sentralstasjonen Fysio', dl:'Lene Bjoland Harstad', phone:'22 40 35 70', email:'', category:'Fysio', channel:'telefon', planned:'', address:'', owner:'Ulrik', status:'takket-nei', fitScore:0, painPoints:['','',''], nextStep:'', notes:'', gatekeeper:'', callAttempts:0, history:[{action:'Takket nei',date:'2026-04-22',by:'Ulrik'}], lastContacted:'2026-04-22', lastUpdatedBy:'Ulrik', lastUpdatedAt:'2026-04-22' },
];
